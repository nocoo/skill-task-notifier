...
class TestBarkNotification(unittest.TestCase):
    ...
    def test_send_bark_notification_icon_fallback(self, mock_print, mock_urlopen):
        ...
        config_no_icon = {
            "bark_server": "https://api.day.app",
            "bark_key": "test_key_123",
            "icons": {"info": "https://example.com/info.png"},
        }
    ...
    def test_send_bark_notification_no_icons(self, mock_print, mock_urlopen):
        ...
        config_no_icons = {"bark_server": "https://api.day.app", "bark_key": "test_key_123"}
    ...
    def test_send_bark_notification_default_group(self, mock_print, mock_urlopen):
        ...
        config_no_group = {"bark_server": "https://api.day.app", "bark_key": "test_key_123"}
...
class TestSystemNotification(unittest.TestCase):
    ...
    def test_send_macos_notification_success(self, mock_print, mock_run):
        ...
        expected_cmd = ["osascript", "-e", 'display notification "Test message" with title "Test Title"']
    ...
    def test_send_linux_notification_success(self, mock_print, mock_run):
        ...
        mock_run.assert_called_once_with(
            ["notify-send", "Test Title", "Test message"], check=True, capture_output=True, timeout=5
        )
...
class TestMainFunction(unittest.TestCase):
    ...
    @patch("sys.stderr", new_callable=MagicMock)
    def test_main_success_all_channels(
        self,
        mock_stderr,
        mock_play_sound,
        mock_system_notify,
        ...
        mock_load_config.return_value = {"bark_key": "test_key", "sound_enabled": True, "system_notify_enabled": True}
    ...
    def test_main_error_level(self, mock_stderr, mock_play_sound, mock_system_notify, mock_bark, mock_load_config):
        ...
        mock_bark.assert_called_once_with(mock_load_config.return_value, "error", "Error message")
    ...
    def test_main_sound_disabled(self, mock_stderr, mock_play_sound, mock_system_notify, mock_bark, mock_load_config):
        ...
        mock_load_config.return_value = {"bark_key": "test_key", "sound_enabled": False, "system_notify_enabled": True}
        mock_bark.return_value = True
        mock_system_notify.return_value = True
    ...
    @patch("notify.play_sound")
    @patch("sys.stderr", new_callable=MagicMock)
    def test_main_system_notify_disabled(
        self,
        mock_stderr,
        mock_play_sound,
        mock_system_notify,
        ...
        mock_load_config.return_value = {"bark_key": "test_key", "sound_enabled": True, "system_notify_enabled": False}
        mock_bark.return_value = True
        mock_play_sound.return_value = True
    ...
    @patch("notify.play_sound")
    @patch("sys.stderr", new_callable=MagicMock)
    def test_main_all_channels_failed(
        self,
        mock_stderr,
        mock_play_sound,
        mock_system_notify,
